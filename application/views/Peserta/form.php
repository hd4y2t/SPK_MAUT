                ...
                <div class="col-sm-6">
                  <select class="form-control" name="id_universitas">
                    ...
                    foreach ($univ as $golongan) {
                      echo '<option value=' . $golongan->id_universitas . ' >' . $golongan->nama_universitas;
                      '</option>';
                    }
                    ?>
                  </select>
                ...
                <div class="col-sm-6 ">
                  <select class="form-control" name="id_jurusan">
                    ...
                    foreach ($jurusan as $golongan) {
                      echo '<option value=' . $golongan->id_jurusan . ' >' . $golongan->jurusan;
                      '</option>';
                    }
                    ?>
                  </select>
                ...
                <div class="col-sm-6 ">
                  <select class="form-control" name="id_akademik">
                    ...
                    foreach ($akademik as $golongan) {
                      echo '<option value=' . $golongan->id_akademik . ' >' . $golongan->tahun;
                      '</option>';
                    }
                    ?>
                  </select>
                ...
                <div class="box box-info ">
                  ...
                  foreach ($pengguna as $golongan) {
                    ...
                    <div class="box-body">
                      ...
                      <div class="col-sm-6">
                        <input type="text" class="form-control input-sm" name="' . $golongan->id_kriteria . '">
                      </div>
                    </div>';
                  } ?>
                </div>
